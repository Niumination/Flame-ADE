...
import { getFileIcon } from "@/modules/explorer/lib/icons";
import {
  Alert02Icon,
  ArrowDown01Icon,
  ArrowRight01Icon,
            ...
            <div className="relative shrink-0 space-y-2 border-b border-border/40 bg-gradient-to-b from-card/65 to-card/30 px-2.5 pb-2.5 pt-2.5">
              ...
              >
                <Textarea
                  ...
                  rows={3}
                  className={cn(
                    "min-h-[72px] resize-none rounded-lg bg-transparent px-3 pb-7 pt-2.5 text-[12.5px] leading-snug shadow-none placeholder:text-muted-foreground/65 focus-visible:ring-0 focus:border-0",
                  )}
                />
...
const EntryRow = memo(function EntryRow({
  ...
  return (
    ...
    >
      ...
      >
        <span className="size-4 shrink-0 flex items-center justify-center text-[11px]">
          {fileIcon}
        </span>
