    ...
    todo_write: tool({
      ...
      inputSchema: z.object({
        todos: z.array(z.object({
          id: z.string().optional().describe("Stable id; generated if omitted. Reuse ids across calls to keep UI stable."),
      ...
      execute: async ({ todos }) => {
        ...
        const normalized: Todo[] = todos.map((t: { id?: string; title: string; description?: string; status: string }) => ({
          id: t.id ?? newTodoId(),
          title: t.title,
