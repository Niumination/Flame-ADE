...
export function BackgroundImage({ imageId, onCleanup }: { imageId: string; onCleanup?: () => void }) {
  const [state, setState] = useState<{ url: string; animated: boolean } | null>(null);
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      const animated = t === "image/gif" || t === "image/apng" || t === "image/webp";
  ...
  return createPortal(
    <div
      ...
      style={{
        ...
        opacity: visible && !suspendAnimated ? 1 : 0,
